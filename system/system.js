...
const MOTION = [
	...
	['--t-develop', 'The develop', 'color, hairlines and grey, ease', 'The one arrival. The address settles, the claim follows, rules draw left to right, settling type comes up with its ink and the marks come up from grey: once per visit, on first sight, and the page never moves while it happens.'],
